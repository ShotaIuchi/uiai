...
重複した変数定義のうち、最初の定義を維持し、後続を削除。

**修正ルール**:
1. 最初の出現をそのまま維持
2. 2回目以降の出現を削除
3. YAMLの重複キーは通常パーサーで後勝ちになるが、修正では最初を採用
...
**注意**: YAMLパーサーの仕様上、重複キーは検出が難しい場合がある。lint ツールとの併用を推奨。
...
| E023 | 構造的な問題 |
| E030 | 変数の値は特定できない |
| E031 | 適切な変数名は人間が決定すべき |
| W001 | 意図的な場合がある |
| W002 | 検証内容は人間が決定すべき |
| W003 | 意図的な場合がある |
| W005 | 意図的な場合がある（将来使う予定かもしれない） |
